...
public class HotelTest {
	...
	/**
	 * Sets the instance variable <tt>hotel</tt> to a well-defined initial
	 * value. All test methods should be preceded by a call to this method.
	 */
	@Before
	public void setUp() {
	...
	/**
	 * checkIn must, as long as rooms are available, return a room occupied by
	 * the specified guest. When the hotel is full, checkIn must return null.
	 */
	@Test
	...
	/**
	 * If the specified guest is checked in, he must be checked out, i.e.,
	 * afterwards, he must not have a room anymore, and his room must now be
	 * empty. The room's safe must be inactivated as well.
	 */
	@Test
	...
	/**
	 * If the guest is checked in, the returned room must be occupied by the
	 * specified guest.
	 */
	@Test
	...
	/**
	 * ToString is difficult to test fully because there is no restriction on
	 * the format of the returned String. At least it can be tested that a
	 * String is returned and that it contains the name of a checked in guest.
	 */
	@Test
