	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				System.out.println("File: " + args[0].toString() + " not found");
			}
		}

		Card aceSpades = new Card(SPADES, ACE);
		Card tenHearts = new Card(HEARTS, TEN);
		Card nineDiamonds = new Card(DIAMONDS, '9');
		aceSpades.write(print);
		tenHearts.write(print);
		nineDiamonds.write(print);
